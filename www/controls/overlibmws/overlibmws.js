/*
 ...
 overlibmws.js core module - Copyright Foteos Macrides 2002-2004. All rights reserved.
   Initial: August 18, 2002 - Last Revised: October 3, 2004
...
if(time&&over&&!o3_delay){if(o3_timerid>0)clearTimeout(o3_timerid);
o3_timerid=(OLhover&&o3_frame==self&&!OLcursorOff())?0:
setTimeout("cClick()",(o3_timeout=time));
}else{if(o3_removecounter>=1)o3_showingsticky=0;if(!o3_showingsticky){
...
function cClick(){
if(OLloaded&&OLgateOK){OLhover=0;if(over)OLhideObject(over);o3_showingsticky=0;}
return false;
}
