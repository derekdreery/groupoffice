	...
	<div class="subkader-small-top">
		<div class="subkader-small-bottom">
			<div class="subkader-small-center">		
				...
				<p>&nbsp;</p>
				<p>Click <a href="<?php echo $this->createUrl("tickets/site/ticket"); ?>">here</a> to create a new ticket.</p>
				<p>&nbsp;</p>
			</div>
		</div>
	</div>
					...
					<table class="ticket-models-table">
						...
						<?php $i = 0; ?>
							...
							<?php
								...
								$linktoticket = '<a href="'.$this->createUrl("tickets/site/ticket",array("ticket_number"=>$ticket->ticket_number)).'">';
						?>
