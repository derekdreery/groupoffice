...
$updates[]="UPDATE fs_files SET path=replace(path, '".$GLOBALS['GO_CONFIG']->file_storage_path."','');";
$updates[]="UPDATE fs_folders SET path=replace(path, '".$GLOBALS['GO_CONFIG']->file_storage_path."','');";
