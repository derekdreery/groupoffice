...
class GO_Settings_Controller_Setting extends \GO\Base\Controller\AbstractController {
	...
	protected function actionLoad($params){
		...
		$response['data']['addressbook_name_template'] = \GO\Base\Model\AbstractUserDefaultModel::getNameTemplate("GO_Addressbook_Model_Addressbook");
		$response['data']['task_name_template'] = \GO\Base\Model\AbstractUserDefaultModel::getNameTemplate("GO_Tasks_Model_Tasklist");
		$response['data']['calendar_name_template'] = \GO\Base\Model\AbstractUserDefaultModel::getNameTemplate("GO_Calendar_Model_Calendar");
...
//		$GLOBALS['GO_EVENTS']->fire_event('load_global_settings',array(&$response));
	...
	protected function actionSubmit($params) {
		...
		if (!empty($params['addressbook_name_template']))
			\GO\Base\Model\AbstractUserDefaultModel::setNameTemplate("GO_Addressbook_Model_Addressbook",$params['addressbook_name_template']);
		
		if (!empty($params['task_name_template']))
			\GO\Base\Model\AbstractUserDefaultModel::setNameTemplate("GO_Tasks_Model_Tasklist",$params['task_name_template']);
		...
		if (!empty($params['calendar_name_template']))
			\GO\Base\Model\AbstractUserDefaultModel::setNameTemplate("GO_Calendar_Model_Calendar",$params['calendar_name_template']);
