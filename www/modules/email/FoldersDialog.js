 ...
 * 
 * @version $Id: FoldersDialog.js 1955 2008-05-09 11:34:01Z mschering $
 ...
 */
 ...
 GO.email.FoldersDialog = function(config){
	...
	treeEdit.on('beforestartedit', function(editor, boundEl, value){
		if(editor.editNode.attributes.folder_id==0 || editor.editNode.attributes.mailbox=='INBOX')
		{
	...
	getSubscribtionData : function(){
    	...
    	{			    	
			data[i] ={
				...
				subscribed: this.allFoldersStore.data.items[i].get('subscribed'),
