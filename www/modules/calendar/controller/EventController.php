 ...
 *
 */
class GO_Calendar_Controller_Event extends \GO\Base\Controller\AbstractModelController {
...
//			$event->displayId = $response['count']++;
	...
	protected function actionIcs($params) {
		...
		//\GO\Base\Util\Http::outputDownloadHeaders(new \GO_Base_FS_File('calendar.ics'));
		echo $event->toICS();
	}
