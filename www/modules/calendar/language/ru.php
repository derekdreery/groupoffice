...
$l['cumulative']='Неверно задано правило повторения. Следующее событие не может начатся пока не закончится предыдущее.';
...
$l['unauthorized_participants_write']='У Вас недостаточно привелегий для планирования событий следующих пользователей:<br /><br />{NAMES}<br /><br />Вы можете выслать им приглашения и они могут принять и добавитьв свой календарь.';
$l['noCalSelected'] = 'Вы не выбрали ни один календарь для просмотра. Выберине хотя бы один календарь в Настройках.';
$l['month_times'][1]='первый';
$l['month_times'][2]='второй';
$l['month_times'][3]='третий';
$l['month_times'][4]='четвертый';
$l['month_times'][5]='пятый';
$l['rightClickToCopy']='Нажмите праву кнопку мыши чтобы скопировать ссылку';
...
$l["emailSendingNotConfigured"]= 'Отправка E-mail не сконфигурирована.';
$l["privateEvent"]= 'Личное';
$l["noInformationAvailable"]= 'Нет доступной информации';
$l["noParticipantsToDisplay"]= 'Нет участников';
$l["previousDay"]= 'Предыдущий днь';
$l["nextDay"]= 'Следующий день';
$l["noAppointmentsToDisplay"]= 'Нет назначеных событий';
...
$l["list"]='Список';
$l["editRecurringEvent"]='Вы хотите отредактировать текущее вхождение или все повторения?';
...
$l["resourceConflictMsg"]= 'Один или боле ресурсов в этом событии в указанное время уже занят:</br>';
$l["view"]= 'Вид';
...
$l["sendInvitationInitial"]='Хотите разослать собщения с приглашениями участникам?';
$l["sendInvitationUpdate"]='Хотите разослать собщения с изменениями участникам?';
