...
// +----------------------------------------------------------------------+
//
// $Id: Span.php,v 1.2 2005/09/23 09:50:15 mschering Exp $
//
...
class go_date_Span {
     ...
     * @access public
     */
    function go_date_Span($time = 0, $format = null)
    {
    ...
    function setFromArray($time)
    {
        ...
        $tmp1 = new go_date_Span;
        if (!$tmp1->setFromSeconds(@array_pop($time))) {
            return false;
        }
        $tmp2 = new go_date_Span;
     ...
     *
     * @param  object go_date_Span $time Source time span object.
     *
     * @return bool   True on success.
     *
     * @access public
     ...
     * Adds a time span.
     *
     * @param  object go_date_Span $time Time span to add.
     *
     * @access public
     */
    function add($time)
     ...
     * negative time spans).
     *
     * @param  object go_date_Span $time Time span to subtract.
     *
     * @access public
     */
     ...
     *
     * @param  object go_date_Span $time Time span to compare to.
     *
     ...
     *
     * @param  object go_date_Span $time1 The first time span.
     * @param  object go_date_Span $time2 The second time span.
     *
     ...
     *
     * @return object go_date_Span Copy of the object.
     */
    function __clone() {
        $c = get_class($this);
        $s = new $c;
