...
// +----------------------------------------------------------------------+
//
// $Id: TimeZone.php,v 1.2 2005/09/23 09:50:15 mschering Exp $
//
// go_date_TimeZone Class
//
 ...
 * go_date_TimeZone::setDefault().<br>
 *
...
class go_date_TimeZone
{
     ...
     * @return object go_date_TimeZone the new go_date_TimeZone object
     */
    function go_date_TimeZone($id)
    {
     ...
     *
     * @access public
     * @return object go_date_TimeZone the default time zone
     */
    function getDefault()
    {
        global $_DATE_TIMEZONE_DEFAULT;
        return new go_date_TimeZone($_DATE_TIMEZONE_DEFAULT);
    }
     ...
     * to a given go_date_TimeZone object.
     *
     * @access public
     * @param object go_date_TimeZone $tz the timezone to test
     ...
     *
     * @access public
     * @param object go_date_TimeZone $tz the timezone object to test
...
if(isset($_DATE_TIMEZONE_DEFAULT)
    && go_date_TimeZone::isValidID($_DATE_TIMEZONE_DEFAULT)
) {
    go_date_TimeZone::setDefault($_DATE_TIMEZONE_DEFAULT);
} elseif (getenv('PHP_TZ') && go_date_TimeZone::isValidID(getenv('PHP_TZ'))) {
    go_date_TimeZone::setDefault(getenv('PHP_TZ'));
} elseif (getenv('TZ') && go_date_TimeZone::isValidID(getenv('TZ'))) {
    go_date_TimeZone::setDefault(getenv('TZ'));
} elseif (go_date_TimeZone::isValidID(date('T'))) {
    go_date_TimeZone::setDefault(date('T'));
} else {
    go_date_TimeZone::setDefault('UTC');
}
//
// END
?>
