...
<tr>
	...
	<td class="HeaderBar" style="text-align:left;padding-left:5px;vertical-align:top;padding-top:4px;">
    ...
    $input->set_attribute('style','background-color:#E6EFF4;border:1px solid black;color:black;padding-left:1px;');
