...
<?php
$GLOBALS['GO_THEME']->add_stylesheet($GLOBALS['GO_CONFIG']->root_path.'ext/resources/css/ext-all.css', $GLOBALS['GO_CONFIG']->host.'ext/resources/css/');
$GLOBALS['GO_THEME']->add_stylesheet($GLOBALS['GO_CONFIG']->root_path.'themes/Default/xtheme-groupoffice.css', $GLOBALS['GO_CONFIG']->host.'themes/Default/');
$GLOBALS['GO_THEME']->add_stylesheet($GLOBALS['GO_CONFIG']->root_path.'themes/Default/style.css', $GLOBALS['GO_CONFIG']->host.'themes/Default/');
