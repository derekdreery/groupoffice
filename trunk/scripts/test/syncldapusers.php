...
require_once(GO::modules()->modules['ldapauth']['class_path'].'ldapauth.class.inc.php');
...
//			require(GO::modules()->modules['calendar']['class_path'].'calendar.class.inc.php');
//			$cal = new calendar();
//			$cal->user_delete($gouser);
//
//			require(GO::modules()->modules['tasks']['class_path'].'tasks.class.inc.php');
//			$t = new tasks();
//			$t->user_delete($gouser);
//
//			require(GO::modules()->modules['files']['class_path'].'files.class.inc.php');
//			$files = new files();
