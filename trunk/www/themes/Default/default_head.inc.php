...
<?php
GO::theme()->add_stylesheet(GO::config()->root_path.'ext/resources/css/ext-all.css', GO::config()->host.'ext/resources/css/');
GO::theme()->add_stylesheet(GO::config()->root_path.'themes/Default/xtheme-groupoffice.css', GO::config()->host.'themes/Default/');
GO::theme()->add_stylesheet(GO::config()->root_path.'themes/Default/style.css', GO::config()->host.'themes/Default/');
