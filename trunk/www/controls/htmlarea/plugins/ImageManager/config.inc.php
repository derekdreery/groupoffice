 ...
 * @version $Id: config.inc.php,v 1.4 2005/03/08 13:44:20 mschering Exp $
...
*/
$full_path = $GO_CONFIG->local_path.$_SESSION['htmlarea_imagemanager_path'];
...
*/
$IMConfig['base_url'] = $GO_CONFIG->local_url.$_SESSION['htmlarea_imagemanager_path'];
