...
{
	echo '<script src="'.$GO_CONFIG->host.'ext/ext-all.js'.$suffix.'" type="text/javascript"></script>';
}
?>
...
{
	?>
	<script src="<?php echo $GO_CONFIG->host; ?>javascript/go-all-min.js<?php echo $suffix; ?>" type="text/javascript"></script>
	<?php
}
?>
