 ...
 * 
 * @version $Id: ContainersGrid.js
 * @copyright Copyright Intermesh
 * @author Wilmar van Beusekom <wilmar@intermesh.nl>
 */
 
GO.shipping.ContainersGrid = function(config){
	...
	GO.shipping.ContainersGrid.superclass.constructor.call(this, config);
...
Ext.extend(GO.shipping.ContainersGrid, GO.grid.GridPanel,{
	...
	afterRender : function()
	{
		...
		GO.shipping.ContainersGrid.superclass.afterRender.call(this);
	}
});