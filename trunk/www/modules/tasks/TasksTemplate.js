		...
		'{[this.collapsibleSectionHeader(GO.tasks.lang.incompleteTasks, "tasks-"+values.panelId, "tasks")]}'+
			...
			'<tpl for="tasks">'+
				'<tr class="display-panel-link">'+
					'<td style="padding-right:0px !important;" {[xindex % 2 === 0 ? "class=\\\"display-panel-link-even\\\"" : ""]}><div class="display-panel-link-icon go-model-icon-GO\\Tasks\\Model\\Task"></div></td>'+					
					...
					'<td {[xindex % 2 === 0 ? "class=\\\"display-panel-link-even\\\"" : ""]}><a href="#" onclick="GO.linkHandlers[\'GO\\Tasks\\Model\\Task\'].call(this, {id});" <tpl if="completion_time!=\'\'">class="tasks-completed"</tpl><tpl if="late!=\'\'">class="tasks-late"</tpl>>{name}</a></td>'+
