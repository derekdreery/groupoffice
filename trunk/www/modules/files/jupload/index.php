...
$GLOBALS['GO_SECURITY']->html_authenticate('files');
...
<body>
<p style="font:12px Arial;"><?php echo str_replace('Group-Office', $GLOBALS['GO_CONFIG']->product_name, $lang['common']['uploadMultipleFiles']); ?></p>
        <applet
            ...
            <param name="maxFileSize" value="<?php echo intval($GLOBALS['GO_CONFIG']->max_file_size); ?>" />
