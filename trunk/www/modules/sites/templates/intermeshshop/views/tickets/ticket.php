		...
		<div class="ticket-top-container">
			<div class="ticket-details">
				<div class="ticket-details-title">
					<?php echo GOS::t('tickets_ticketTicketInformation'); ?>
				</div>
	...
	<div class="feature-large">
		<div class="ticket-user-info">
			<div class="ticket-user-title">
				<?php echo GOS::t('tickets_ticketYourInformation'); ?>
			</div>
	...
	<div class="feature-large">
		<div class="ticket-agent-info">
			<div class="ticket-agent-title">
				<?php echo GOS::t('tickets_ticketYourAgent'); ?>
			</div>
			<?php if ($ticket->agent): ?>
			...
			<?php else: ?>
				<div class="ticket-agent-text">
					<?php echo GOS::t('tickets_ticketNoAgent'); ?>
				</div>
			<?php endif; ?>		
		</div>
	</div>
