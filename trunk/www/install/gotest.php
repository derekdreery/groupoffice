...
function test_system(){
	...
	if(is_dir('../modules/professional') && isset($GO_CONFIG))
	{
		...
		{
			$test['feedback']='Fatal: Your professional license is invalid. Please contact Intermesh about this problem and supply the output of this page. <a target="_blank" href="'.$check_url.'">Click here to check the output of an encoded file.</a><br />The output was: '.$content;
			$test['fatal']=true;
			$test['pass']=false;
		}else
		{
