...
$l['success']='<h1>Zmiana hasła</h1><p>Twoje hasło zostało zmienione. Możesz przejść do srtony logowania.</p>';
$l['send']='Wyślij';
$l['login']='Login';
$l['lost_password_subject']='Prośba o nowe hasło';
...
$l['enter_password']='Wprowadź nowe hasło';
$l['new_password']='Nowe hasło';
$l['lost_password']='Zapomniałem hasło';
$l['confirm_password']='Powtórz hasło';
