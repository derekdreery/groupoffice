...
$l['success']='<h1>Passwort geändert</h1><p>Ihr Passwort wurde erfolgreich geändert. Sie können sich ab jetzt mit Ihrem neuen Passwort einloggen.</p>';
$l['send']='Senden';
$l['login']='Einloggen';
$l['lost_password_subject']='Neues Passwort angefordert';
...
$l['enter_password']='Bitte geben Sie ein neues Passwort an';
$l['new_password']='Neues Passwort';
$l['lost_password']='Altes Passwort';
