...
$l['success']='<h1>Senha alterada</h1><p>Sua senha foi alterada com sucesso. Agora você pode continuar para a página de login.</p>';
$l['send']='Enviar';
$l['login']='Login';
$l['lost_password_subject']='Nova senha solicitada';
...
$l['enter_password']='Por favor digite uma nova senha';
$l['new_password']='Nova senha';
$l['lost_password']='Senha esquecida';
$l['confirm_password']='Confirme a senha';
