...
$lang['common']['quotaExceeded']= 'Du har inget diskutrymme kvar. Ta bort några filer eller kontakta din leverantör för att öka kvoten';
$lang['common']['errorsInForm'] = 'Det var fel i formuläret. Rätta till dem och försök igen.';

$lang['common']['moduleRequired']= 'Modulen % krävs för denna funktion';
...
$lang['common']['search']= 'Söka';
$lang['common']['settings']= 'Inställningar';
$lang['common']['adminMenu']= 'Admin meny';
...
$lang['common']['default_salutation']['M']= 'Kära Herr';
$lang['common']['default_salutation']['F']= 'Kära Ms';
$lang['common']['default_salutation']['unknown']= 'Kära Herr / Fru';
...
$lang['common']['group_internal']= 'Inre';

$lang['common']['admin']= 'Administratör';

$lang['common']['beginning']= 'Hälsning';

$lang['common']['max_emails_reached']= 'Det högsta antalet e-post till SMTP värd% s av% s per dag har uppnåtts.';
$lang['common']['usage_stats']= 'Diskutrymmesanvändning per %s';
$lang['common']['usage_text']= 'Denna Group-Office installationen använder';
...
$lang['common']['lost_password_subject']= 'Nytt lösenord';
$lang['common']['lost_password_body']= '%s,<br />
<br />
Du frågade efter ett nytt lösenord till %s.<br />
<br />
Dina nya login detaljer är:<br />
<br />
Användarnamn: %s<br />
Lösenord: %s';

$lang['common']['lost_password_error']= 'Kunde inte hitta angiven e-postadress.';
$lang['common']['lost_password_success']= 'Ett nytt lösenord har skickats till din e-postadress.';
