 ...
 *
 * Changed by Mathias Näsström, ITSAM
 * 10 March 2010
 */
...
if(Ext.TabPanelItem){
   Ext.TabPanelItem.prototype.closeText = "Stäng den här fliken";
}
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    createLinkText : 'Fyll i länkens URL:',
    buttonTips : {
      bold : {
      ...
      sourceedit : {
        ...
        text: 'Ändra till läge för att redigera direkt i HTML-koden.',
        cls: 'x-html-editor-tip'
      }
    }
  });
