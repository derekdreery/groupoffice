...
$lang['backupmanager']['no_mysql_config']='Group-Office не смог обнарудить конфигурауионный файл mysql. Этот файл нужен для создания полной резервной копии базы данных. Вы можете создать этот файл в директории /etc/groupoffice/ самостоятельно. Имя файла backupmanager.inc.php В файле должно содержаться следующее:
    <br /><br />&lt;?php<br />
