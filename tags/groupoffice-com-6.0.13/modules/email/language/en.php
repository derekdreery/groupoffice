...
$l["addUnknownSendersText"]='You are adding selected email senders to an address list. First, the following selected senders must be added to a Group-Office address book. Click on a name if you want to add that person or close this window.';
...
$l["folder"]= 'Folder';
$l["moveOldMailsSure"]= 'Are you sure you want to move all the emails older than {date} from "{source}" to "{target}"?';
...
$l['iCalendar_event_not_found']='The appointment of this message was deleted.';
$l['iCalendar_update_available']='This message contains an update to an event.';
