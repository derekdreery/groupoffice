...
/**
 * go_date_Calc is a calendar class used to calculate and
...
class go_date_Calc
{
    ...
    {
        $this_year = go_date_Calc::dateNow('%Y');
        $this_month = go_date_Calc::dateNow('%m');
        $this_day = go_date_Calc::dateNow('%d');
    ...
    function dayOfWeek($day='',$month='',$year='')
    {
        ...
        if (empty($month)) {
            $month = go_date_Calc::dateNow('%m');
        }
        if (empty($day)) {
            $day = go_date_Calc::dateNow('%d');
        }
    ...
    function weekOfYear($day='',$month='',$year='')
    {
        ...
        $iso    = go_date_Calc::gregorianToISO($day, $month, $year);
        $parts  = explode('-',$iso);
    ...
    function julianDate($day='',$month='',$year='')
    {
        ...
        if ($month > 2 && go_date_Calc::isLeapYear($year)) {
            $julian++;
        }
    ...
    function beginOfNextMonth($day='',$month='',$year='',$format='%Y%m%d')
    {
        ...
        return go_date_Calc::dateFormat($day,$month,$year,$format);
    ...
    function endOfNextMonth($day='',$month='',$year='',$format='%Y%m%d')
    {
        ...
        $day = go_date_Calc::daysInMonth($month,$year);
    ...
    function nextWeekday($day='',$month='',$year='',$format='%Y%m%d')
    {
        ...
        $days = go_date_Calc::dateToDays($day,$month,$year);

        if (go_date_Calc::dayOfWeek($day,$month,$year) == 5) {
            $days += 3;
        } elseif (go_date_Calc::dayOfWeek($day,$month,$year) == 6) {
            $days += 2;
        } else {
            $days += 1;
        }

        return(go_date_Calc::daysToDate($days,$format));
    ...
    function prevWeekday($day='',$month='',$year='',$format='%Y%m%d')
    {
        ...
        if (go_date_Calc::dayOfWeek($day,$month,$year) == 1) {
            $days -= 3;
        } elseif (go_date_Calc::dayOfWeek($day,$month,$year) == 0) {
            $days -= 2;
        } else {
            $days -= 1;
        }
    ...
    function nextDayOfWeek($dow,$day='',$month='',$year='',$format='%Y%m%d',$onOrAfter=false)
    {
        ...
        $days = go_date_Calc::dateToDays($day,$month,$year);
        $curr_weekday = go_date_Calc::dayOfWeek($day,$month,$year);
    ...
    {
        return(go_date_Calc::nextDayOfWeek($dow,$day,$month,$year,$format,true));
    ...
    {
        return(go_date_Calc::prevDayOfWeek($dow,$day,$month,$year,$format,true));
    ...
    function nextDay($day='',$month='',$year='',$format='%Y%m%d')
    {
        ...
        return(go_date_Calc::daysToDate($days + 1,$format));
    } // end func nextDay
    ...
    * @param string $year2  year in format CCYY
    ...
    {
        if (!go_date_Calc::isValidDate($day1,$month1,$year1)) {
            return -1;
        }
        if (!go_date_Calc::isValidDate($day2,$month2,$year2)) {
            return -1;
        }

        return(abs((go_date_Calc::dateToDays($day1,$month1,$year1))
                    - (go_date_Calc::dateToDays($day2,$month2,$year2))));
    } // end func dateDiff
    ...
    */
    ...
    {
        $ndays1 = go_date_Calc::dateToDays($day1, $month1, $year1);
        $ndays2 = go_date_Calc::dateToDays($day2, $month2, $year2);
        if ($ndays1 == $ndays2) {
            return 0;
        }
    ...
    function daysInMonth($month='',$year='')
    {
        ...
        if ($month == 2) {
            if (go_date_Calc::isLeapYear($year)) {
                return 29;
             } else {
                return 28;
            }
    ...
    function weeksInMonth($month='',$year='')
    {
        ...
        $FDOM = go_date_Calc::firstOfMonthWeekday($month, $year);
        ...
        $first_week_days %= 7;
        return (ceil((go_date_Calc::daysInMonth($month, $year) - $first_week_days) / 7) + $weeks);
    ...
    function firstOfMonthWeekday($month='',$year='')
    {
        ...
        return(go_date_Calc::dayOfWeek('01',$month,$year));
    ...
    function beginOfMonth($month='',$year='',$format='%Y%m%d')
    {
        ...
        return(go_date_Calc::dateFormat('01',$month,$year,$format));
    ...
    function beginOfWeek($day='',$month='',$year='',$format='%Y%m%d')
    {
        ...
        $this_weekday = go_date_Calc::dayOfWeek($day,$month,$year);

        $interval = (7 - DATE_CALC_BEGIN_WEEKDAY + $this_weekday) % 7;

        return(go_date_Calc::daysToDate(go_date_Calc::dateToDays($day,$month,$year) - $interval,$format));
    ...
    function beginOfNextWeek($day='',$month='',$year='',$format='%Y%m%d')
    {
        ...
        $date = go_date_Calc::daysToDate(
                    go_date_Calc::dateToDays($day+7,$month,$year),"%Y%m%d"
                );
        ...
        return go_date_Calc::beginOfWeek(
                            $next_week_day,$next_week_month,$next_week_year,
                            $format
                        );

        $date = go_date_Calc::daysToDate(go_date_Calc::dateToDays($day+7,$month,$year),"%Y%m%d");
    ...
    function beginOfPrevWeek($day='',$month='',$year='',$format='%Y%m%d')
    {
        ...
        return go_date_Calc::beginOfWeek($prev_week_day,$prev_week_month,$prev_week_year,$format);
    ...
    function getCalendarWeek($day='',$month='',$year='',$format='%Y%m%d')
    {
        ...
        $curr_day = go_date_Calc::beginOfWeek($day,$month,$year,'%E');

        for($counter=0; $counter <= 6; $counter++) {
            $week_array[$counter] = go_date_Calc::daysToDate($curr_day,$format);
            $curr_day++;
        }
    ...
    function getCalendarMonth($month='',$year='',$format='%Y%m%d')
    {
        ...
        if (DATE_CALC_BEGIN_WEEKDAY == 1) {
            if (go_date_Calc::firstOfMonthWeekday($month,$year) == 0) {
                $curr_day = go_date_Calc::dateToDays('01',$month,$year) - 6;
            } else {
                $curr_day = go_date_Calc::dateToDays('01',$month,$year)
                    - go_date_Calc::firstOfMonthWeekday($month,$year) + 1;
            }
        } else {
            $curr_day = (go_date_Calc::dateToDays('01',$month,$year)
                - go_date_Calc::firstOfMonthWeekday($month,$year));
        }

        // number of days in this month
        $daysInMonth = go_date_Calc::daysInMonth($month,$year);

        $weeksInMonth = go_date_Calc::weeksInMonth($month,$year);
        for($row_counter=0; $row_counter < $weeksInMonth; $row_counter++) {
            for($column_counter=0; $column_counter <= 6; $column_counter++) {
                $month_array[$row_counter][$column_counter] =
                    go_date_Calc::daysToDate($curr_day,$format);
                $curr_day++;
            }
        }
    ...
    function getCalendarYear($year='',$format='%Y%m%d')
    {
        ...
        for($curr_month=0; $curr_month <=11; $curr_month++) {
            $year_array[$curr_month] =
                go_date_Calc::getCalendarMonth(sprintf('%02d',$curr_month+1),$year,$format);
        }
    ...
    function daysToDate($days,$format='%Y%m%d')
    {
        ...
        return(go_date_Calc::dateFormat($day,$month,$century.$year,$format));
    } // end func daysToDate
    ...
    function NWeekdayOfMonth($occurance,$dayOfWeek,$month,$year,$format='%Y%m%d')
    {
        ...
        $DOW1 = go_date_Calc::dayOfWeek($DOW1day,$month,$year);

        $wdate = ($occurance - 1) * 7 + 1 +
                (7 + $dayOfWeek - $DOW1) % 7;

        if ( $wdate > go_date_Calc::daysInMonth($month,$year)) {
            return -1;
        } else {
            return(go_date_Calc::dateFormat($wdate,$month,$year,$format));
        }
    ...
    {
        if (!go_date_Calc::isValidDate($day,$month,$year)) {
            $year = go_date_Calc::dateNow('%Y');
            $month = go_date_Calc::dateNow('%m');
            $day = go_date_Calc::dateNow('%d');
        }
        ...
        for($strpos = 0; $strpos < strlen($format); $strpos++) {
            ...
            if ($char == '%') {
                ...
                switch($nextchar) {
                    case 'a':
                        $output .= go_date_Calc::getWeekdayAbbrname($day,$month,$year);
                        break;
                    case 'A':
                        $output .= go_date_Calc::getWeekdayFullname($day,$month,$year);
                        break;
                    case 'b':
                        $output .= go_date_Calc::getMonthAbbrname($month);
                        break;
                    case 'B':
                        $output .= go_date_Calc::getMonthFullname($month);
                        break;
                    case 'd':
                    ...
                    case 'e':
                        ...
                        break;
                    case 'E':
                        $output .= go_date_Calc::dateToDays($day,$month,$year);
                        break;
                    case 'j':
                        $output .= go_date_Calc::julianDate($day,$month,$year);
                        break;
                    case 'm':
                    ...
                    case "t":
                        ...
                        break;
                    case 'w':
                        $output .= go_date_Calc::dayOfWeek($day,$month,$year);
                        break;
                    case 'U':
                        $output .= go_date_Calc::weekOfYear($day,$month,$year);
                        break;
                    case 'y':
    ...
    function getMonthFullname($month)
    {
        ...
        if (empty($month)) {
            $month = (int) go_date_Calc::dateNow('%m');
        }

        $month_names = go_date_Calc::getMonthNames();
     ...
     * @see go_date_Calc::getMonthFullname
     */
    ...
    function getMonthAbbrname($month,$length=3)
    {
        ...
        return substr(go_date_Calc::getMonthFullname($month), 0, $length);
    ...
    function getWeekdayFullname($day='',$month='',$year='')
    {
        ...
        $weekday_names = go_date_Calc::getWeekDays();
        $weekday = go_date_Calc::dayOfWeek($day,$month,$year);
     ...
     *
     * @return string full month name
     * @see go_date_Calc::getWeekdayFullname
     */
    ...
    function getWeekdayAbbrname($day='',$month='',$year='',$length=3)
    {
        ...
        return substr(go_date_Calc::getWeekdayFullname($day,$month,$year),0,$length);
    } // end func getWeekdayFullname
    ...
    */
    function getMonthFromFullName($month)
    {
        ...
        $months = go_date_Calc::getMonthNames();
    ...
    */
    ...
    function gregorianToISO($day,$month,$year) {
        ...
        $y_isleap = go_date_Calc::isLeapYear($year);
        $y_1_isleap = go_date_Calc::isLeapYear($year - 1);
