...
class GO_Customfields_Model_Category extends GO_Base_Db_ActiveRecord{
	...
	public function relations() {
		...
		'_fieldsSortedById' => array('type' => self::HAS_MANY, 'model' => 'GO_Customfields_Model_Field', 'field' => 'category_id', 'delete' => true, 'findParams'=>  GO_Base_Db_FindParams::newInstance()->order('id')),
				);
	}
