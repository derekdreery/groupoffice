...
$l['rightClickToCopy']='Clic amb el botó dret per copiar l\'adreça de l\'enllaç';
$l['invitation']='Invitació';
$l['invitation_update']='Invitació actualitzada';
$l['cancellation']='Cancel·lació';
$l['non_selected']= 'en un calendari no seleccionat';
$l['linkIfCalendarNotSupported']='Utilitzar els enllaços de sota només si el vostre client de correu no suporta funcions de calendari.';
$l['statuses']['CONFIRMED']= 'Confirmat';
$l['repeats_not_every']= 'Repetir cada %s %s';
