...
All rights reserved.
Το πρόγραμμα αυτό προστατεύεται από το νόμο περί πνευματικών δικαιωμάτων και την άδεια λογισμικού Group-Office.

Για ερωτήσεις τεχνικής υποστήριξης επικοινωνήστε με τον διαχειριστή του ιστοτόπου:
%s

Για περισσότερες πληροφορίες σχετικά με το Group-Office επισκευθείτε την διεύθυνση:
http://www.group-office.com

Το Group-Office δημιουργήθηκε από την εταιρεία Intermesh. Για περισσότερες πληροφορίες σχετικά με την Intermesh επισκευθείτε την διεύθυνση:
...
$lang['common']['usage_text']='Αυτή η εγκατάσταση του Group-Office χρησιμοποιεί';
...
$lang['common']['confirm_leave']='Εάν βγείτε από την εφαρμογή Group-Office θα χάσετε πιθανώς μη αποθηκευμένες αλλαγές';
$lang['common']['dataSaved']='Τα δεδομένα αποθηκεύθηκαν με επιτυχία';

$lang['common']['uploadMultipleFiles'] = 'Κάντε κλικ στο \'Περιήγηση\' για να επιλέξτε αρχεία ή/και καταλόγους από τον υπολογιστή σας. Κάντε κλίκ στο \'Ανέβασμα\' για να μεταφέρετε τα αρχεία στην εφαρμογή Group-Office. Το παράθυρο αυτό θα κλείσει αυτόματα όταν ολοκληρωθεί η μεταφορά.';