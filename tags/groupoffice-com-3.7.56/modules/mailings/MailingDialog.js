...
GO.mailings.MailingDialog = function(config){
	...
	config.title= GO.mailings.lang.addresslist;
	...
	GO.mailings.MailingDialog.superclass.constructor.call(this, config);
	
	this.addEvents({'save' : true});	
}

Ext.extend(GO.mailings.MailingDialog, Ext.Window,{
		...
		if(this.mailing_id>0)
		{
			this.formPanel.load({
				...
				success:function(form, action)
				{
					...
					GO.mailings.MailingDialog.superclass.show.call(this);
				},
	...
	buildForm : function () {
		...
		this.propertiesPanel = new Ext.Panel({
			...
			items:[{
			  ...
			  fieldLabel: GO.lang.strName
				...
				html: GO.mailings.lang.defaultSalutationText,
		...
		this.contactsGrid = new GO.mailings.MailingContactsGrid();
