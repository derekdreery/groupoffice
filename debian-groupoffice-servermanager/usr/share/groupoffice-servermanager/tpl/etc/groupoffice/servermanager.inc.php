<?php
$sm_config['install_path']='/home/govhosts/';
...
$sm_config['install_modules']='summary,email,calendar,tasks,addressbook,notes,files,modules,users,groups,tools,serverclient,links,comments,log,mailings,calllog,gota,billing,projects,timeregistration,hoursapproval,sync,customfields,caldav,dav,search,reminders';
...
$default_config['allowed_modules']='summary,email,calendar,tasks,addressbook,notes,files,modules,users,groups,tools,serverclient,links,comments,log,mailings,calllog,gota,billing,projects,timeregistration,hoursapproval,sync,customfields,caldav,dav,search,reminders';
