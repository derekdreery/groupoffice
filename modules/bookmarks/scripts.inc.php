...
while($bookmark = $stmt->fetch()){
	...
	$GO_SCRIPTS_JS .= 'GO.moduleManager.addModule(\'bookmarks-id-' . $bookmark->id . '\', GO.panel.IFrameComponent, {title : \'' . String::escape_javascript($name) . '\', url : \'' . String::escape_javascript($bookmark->content) . '\'});';
}