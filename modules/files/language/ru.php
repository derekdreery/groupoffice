...
$l['name'] = 'Файлы';
$l['description'] = 'Модуль Фалы; Модуль для совместного использования файлов.';
$lang['link_type'][6]='Файл';
$lang['link_type'][17]='Папка';
$l['fileNotFound'] = 'Файл не найден';
$l['folderExists'] = 'Папка уже существует';
$l['filenameExists'] = 'Имя файла уже существует';
$l['uploadedSucces'] = 'Файл размещен на сервере без ошибок';
...
$l["file"]='Файл';
$l["emptyList"]='Постой список';
$l["newFiles"]='Новый';
$l["olderVersions"]='Старые версии';
$l["uploadProperties"]='Эти настройки будут применены для всех фалов загруженных с опцией "Маленькие файлы"';
...
$l["expireTime"]= 'Вермя жизни ссылки';
$l["possibleUntil"]= 'возможно до';