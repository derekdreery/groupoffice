GO.calendar.CalendarSelectGrid = function (config){
	config = config || {};
	...
	GO.calendar.CalendarSelectGrid.superclass.constructor.call(this, config);
	
	this.addEvents({change : true});
}

Ext.extend(GO.calendar.CalendarSelectGrid, GO.grid.GridPanel,{
