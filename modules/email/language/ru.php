...
$l['feedbackCannotConnect'] = 'Невозможно соедениться с %1$ по порту %3$s<br /><br />Почтовый сервер вернул: %2$s';
$l['inbox'] = 'Входящие';
$l['spam']='Спам';
$l['trash']='Корзина';
$l['sent']='Отправленные';
...
$l['from']='От';
$l['subject']='Тема';
$l['no_recipients']='Неуказаны получатели';
...
$l['draftsDisabled']="Невозможно сохранить сообщение потому что отключена папка 'Черновики' .<br /><br />Настройте ее в Настройки -> Учетные записи -> Учетная запись -> Папки.";
$l['noSaveWithPop3']='Невозможно сохранить сообщение потому что POP3 учетные записи не поддерживают этого.';
$l['goAlreadyStarted']='Group-Office уже запущен и в нем открыт редактор e-mail сообщений. Закройте это окно и напишите Ваше сообщение в Group-Office.';
...
$l['disable_trash_folder']='Не удалось выбросить Ваше письмо в Корзину. Возможно у Вас закончилось свободное место. Вы можете освободить место отключив использование папки Корзина в:\n\nНастройки -> Учетные записи -> Учетная запись -> Папки. и удалите ненужные сообщения в других папках.';
$l['error_move_folder']='Не возможно переместить папку';
$l['error_getaddrinfo']='Указан неверный адрес хоста';
$l['error_authentication']='Неверно имя пользователя или пароль';
$l['error_connection_refused']='В соединении отказано. Пожалуйста, проверьте адрес хоста и номер прота.';
$l['iCalendar_event_invitation']='Это сообщение содержите приглашение на событие.';
...
$l['iCalendar_event_invitation_declined']='Это сообщение содержите приглашение на событие которое Вы отклонили.';
...
$l["attachFiles"]='Присоеденить файл с Вашего компьютера';
...
$l["noAccountTitle"]='Нет учентой записи';
$l["priority"]='Приоритет';
$l["read"]='Прочитано';
$l["NA"]='Нет данных';
$l["emptyFolder"]='Очистить папку';
$l["emptyFolderConfirm"]='Вы уверенны что хотите очистить\'{name}\'?';
...
$l["attachFilesPC"]='Присоеденить файлы с компьютера';
$l["attachFilesGO"]='Присоеденить файлы из {product_name}';
$l["renameFolder"]='Переименовать папку';
$l["vacation"]='Автоматический ответ';
$l["vacationActive"]='Активировать автоматический ответ';
...
$l["sendNotification"]='Отправитель этого сообщения пожелал получить уведомление о прочтении: %s. Хотите отправить уведомление сейчас?';
$l["searchOnSender"]='Поиск в Отправителях';
$l["blocked"]= '{blocked_images} внешние рисунки заблокированы для Вашей безопасности.';
...
$l["searchGO"]='Искать в  Group-Office';
...
$l["replaceEmailText"]='У этого контакта уже добавлено три email адреса. Вы можете заменить один из уже записанных адресов кликнув на него.';
...
$l["alwaysRespondToNotifications"]='Всегда отправлять уведомление о прочтении письма';
