...
<div class="main-container">    
	<div class="header">
		<img src="<?php echo $GO_MODULES->modules['mailings']['url'].'extern/template/images/groupoffice.png'; ?>" alt="Group-Office logo" />
	</div>
...
?>			
		...
		<input type="hidden" name="mailing_group_id" id="mailing_group_id" value="<?php echo $data['mailing_group_id'];?>" /><br />
