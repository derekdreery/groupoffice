<?php
class GO_Base_Ldap_Record extends GO_Base_Model {
	/**
	...
	public function __construct(GO_Base_Ldap_Connection $ldapConn = null, $entryId= null) {
		$this->_entryId=$entryId;
		$this->_ldapConn= ($ldapConn!==null) ? $ldapConn : GO_Base_Ldap_Connection::getDefault();
