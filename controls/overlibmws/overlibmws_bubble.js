/*
 overlibmws_bubble.js plug-in module - Copyright Foteos Macrides 2003-2004
   For support of the BUBBLE feature.
   Initial: July 26, 2003 - Last Revised: July 27, 2004 
...
// PRE-INIT
OLloaded=0;
OLregCmds('bubble,bubbletype,adjbubble');
// root names given to images (should be gif file)
...
// image content width in pixels
var OLcontentWidth=[200,250,130,184,190];
// image content height in pixels
var OLcontentHeight=[80,85,150,176,46];
// X displacement of content from image upper left corner
var OLpadLeft=[30,40,7,9,5];
// Y displacement of content from image upper left corner
var OLpadTop=[25,48,10,34,4];
// x location of tip from image upper left corner
var OLarwTipX=[180,50,51,9,19];
// y location of tip from image upper left corner
...
o3_bubble=ol_bubble;o3_bubbletype=ol_bubbletype;o3_adjbubble=ol_adjbubble;OLbubbleHt=0;
}
...
if(ar[k]==-BUBBLE){eval(pf+'bubble=0');return k;}
if(ar[k]==BUBBLETYPE){eval(pf+"bubbletype='"+OLescSglQt(ar[++k])+"'");return k;}
if(ar[k]==ADJBUBBLE){eval(pf+'adjbubble=('+pf+'adjbubble==0)?1:0');return k;}
if(ar[k]==-ADJBUBBLE){eval(pf+'adjbubble=0');return k;}}
return -1;
}
...
// Temporary kudge until handling of TEXTSIZE is finalized.
