...
phpdoc/phpdoc -t ./go_doc/php -ti Group-Office PHP-Documentation -dn GO -ric CHANGELOG, DEVELOPERS, README, RELEASE, TODO, TRANSLATORS, FAQ, LICENSE, Release-1.4.0 -d ../../classes -i dompdf/,fpdf/,mail/phpmailer/,mail/swift/ -o HTML:Smarty:Group-Office -s on
