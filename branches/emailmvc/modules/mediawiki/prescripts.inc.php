...
$title = $GLOBALS['GO_CONFIG']->get_setting('mediawiki_title');
...
$GO_SCRIPTS_JS .= 'Ext.namespace("GO.mediawiki");Ext.namespace("GO.mediawiki.settings");'.
		'GO.mediawiki.settings.externalUrl="'.$GLOBALS['GO_CONFIG']->get_setting('mediawiki_external_url').'";'.
...
<script type="text/javascript">
	...
	GO.mediawiki.settings.externalUrl='<?php echo $GLOBALS['GO_CONFIG']->get_setting('mediawiki_external_url'); ?>';
