...
$l['no_mysql_config']='Group-Office heeft geen mysql config bestand kunnen vinden. Dit is nodig om een backup te kunnen maken van de volledige database. Je kunt deze zelf aanmaken door een bestand met de naam backupmanager.inc.php in /etc/groupoffice/ te plaatsen met de volgende inhoud:;
    <br /><br />&lt;?php<br />;
