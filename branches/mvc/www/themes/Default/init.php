...
//
//$s = '
//var BaseHref = "'.GO::config()->host.'";
//
//GO = {};
//GO.settings='.json_encode(GO::config()->get_client_settings()).';
...
//		$this->registerClientScript('language/common/' . GO::language()->language . '.js');
//	}
//
...
//		$this->registerClientScript('modules/users/language/' . GO::language()->language . '.js');
//	}
//}
//
...
?> 2003-<?php echo date('Y'); ?></div>
	...
	<?php
	if (isset(GO::modules()->modules['search']) && GO::modules()->modules['search']['read_permission']) {
	...
	<?php if (!GO::security()->http_authenticated_session) { ?>
									<span class="top-menu-separator">|</span>
