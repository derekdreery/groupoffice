...
$template_path = isset(GO::config()->mailings_template_path) ? GO::config()->mailings_template_path : GO::modules()->modules['mailings']['path'].'extern/template/';
