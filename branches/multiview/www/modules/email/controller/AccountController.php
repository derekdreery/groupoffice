...
class GO_Email_Controller_Account extends \GO\Base\Controller\AbstractModelController {
...
//			\GO::debug($node);
		...
		\GO\Base\Util\ArrayExtra::caseInsensitiveSort($nodes);
...
//		$store = \GO\Base\Data\Store::newInstance(\GO_Email_Model_Account::model());
