...
//
// $Id: lt.php,v 1.1 2005/04/15 21:23:32 mschering Exp $
...
$text['hardware']       = 'Aparatūriniai duomenys';
...
$text['netusage']       = 'Tinklo duomenys';
$text['device']         = 'Įrenginys';
$text['received']       = 'Parsiųsta';
$text['sent']           = 'Išsiųsta';
$text['errors']         = 'Klaidos/numesti paketai';

$text['memusage']       = 'Atminties duomenys';
$text['phymem']         = 'Operatyvioji atmintis';
$text['swap']           = 'Disko swap skirsnis';

$text['fs']             = 'HDD duomenys';
$text['mount']          = 'Primontuota';
